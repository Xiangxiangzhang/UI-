...
static NSString *headerViewIdentifier = @"hearderView";

+ (instancetype) sectionHearderViewForTableView:(UITableView *)tableView
{
    QYsectionHeaderView *hearderView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:headerViewIdentifier];
    
    if (hearderView ==nil) {
        hearderView = [[QYsectionHeaderView alloc] initWithReuseIdentifier:headerViewIdentifier];
    }
    return hearderView;
}
...
{
    if (self = [super initWithReuseIdentifier:headerViewIdentifier]) {
