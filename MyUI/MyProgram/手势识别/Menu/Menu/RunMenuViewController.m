...
@interface RunMenuViewController ()<RunItemViewDelegate>
...
- (void)configViews {
    ...
    self.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"page9"]];
    NSArray *dataArray = @[@"page1", @"page2", @"page3", @"page4", @"page5"];
    ...
    for (NSInteger i = 0;i < PHOTONUM;i++) {
       ...
       RunItemView *view = [[RunItemView alloc] initWithNormalImage:dataArray[i] highlightedImage:[dataArray[i] stringByAppendingFormat:@"%2@", @"page_%d",i+1] tag:TAGSTART+i title:nil];
